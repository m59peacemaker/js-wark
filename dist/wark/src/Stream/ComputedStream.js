...
var ComputedStream = function (computeFn) {
    ...
    var dependsOn = function (newDependencies) {
        dependencySubscribers.forEach(function (subscriber) { return subscriber.unsubscrube(); });
        dependencies = newDependencies;
        dependencySubscribers = dependencies.map(function (dependency) { return dependency.on('propagation', function () {
        }); });
    };
